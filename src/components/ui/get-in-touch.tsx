  ...
  const socialPlatforms = [
    {
      ...
      link: "https://linkedin.com/in/freelancerlaju",
    ...
    },
    {
      ...
      link: "https://github.com/freelancerlaju",
    ...
    },
    {
      ...
      link: "https://x.com/freelancerlaju",
    ...
    },
    {
      ...
      link: "https://instagram.com/freelancerlaju",
    ...
    },
    {
      ...
      link: "https://facebook.com/fb.freelancerlaju",
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/20 to-background overflow-hidden relative w-full">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-4 sm:p-6 md:p-8">
        ...
        >
          ...
          <p className="text-left md:text-center text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
        ...
        {/* Main Content Grid */}
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 max-w-7xl mx-auto w-full ">
                ...
                >
                  ...
                  <div className="relative bg-gradient-to-br from-card/50 to-card/30 backdrop-blur-xl rounded-xl p-6 border border-border/50 overflow-hidden transition-all duration-500 hover:scale-105 hover:border-border">
                    ...
                    <div className="relative z-10">
                      {/* Icon Container */}
                      <div
                        className={`mb-3 inline-flex p-2 rounded-lg bg-gradient-to-br ${platform.gradient} text-white transform transition-transform duration-500 group-hover:rotate-6 group-hover:scale-110`}
                      >
                        {platform.icon}
                      </div>
          ...
          <div className="relative md:mt-[3rem]">
            <div className="bg-gradient-to-br from-card/50 to-card/30 backdrop-blur-xl rounded-2xl p-4 md:p-8 border border-border/50">
